<footer class="footer">
    <div class="logo-barc">
        <img src="assets\images\1200px-Bhabha_Atomic_Research_Centre_Logo.png" alt="barc_logo" height="150" width="150"/>
        <p>
            <br>
            Made for BARC
        </p>
        ...
        <div class="footer-links">
            ...
            <hr>
                <h3><a href="#">Home</a></h3>
                <h3><a href="User Manual.pdf" target="_blank">How to Use</a></h3>
                <h3><a href="<?= url('faqs.php') ?>">FAQs</a></h3>
        ...
        <div class="footer-contact">
            ...
            <div class="email">
                ...
                <div class="email">
                    ...
                    &nbsp;&nbsp;
                    <h5>aakash20ce@student.mes.ac.in</h5>
                </div>
        </div>
</footer>